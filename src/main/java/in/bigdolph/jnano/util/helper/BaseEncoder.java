 ...
 * created and modified by <a href="https://github.com/LinusU">Linus Unnebäck (LinusU)</a> and <a href="https://github.com/termhn">Gray Olson (termhn)</a>.
 */
public class BaseEncoder {
    ...
    private enum Encoding {
        ...
        public static Encoding getFromBase(int base) {
            for(Encoding type : Encoding.values()) if(type.base == base) return type;
